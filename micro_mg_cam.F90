...
subroutine micro_mg_cam_init(pbuf2d)
   ...
   ! For manual variables
   call addfld ('CLD_ISOTM_0C' ,            horiz_only, 'A', ' ', 'Total cloud fraction near 0C isotherm (discard below thick cloud)'                           )
   call addfld ('CLD_ISOTM_5C' ,            horiz_only, 'A', ' ', 'Total cloud fraction near -5C isotherm (discard below thick cloud)'                          )
   call addfld ('CLD_ISOTM_10C' ,           horiz_only, 'A', ' ', 'Total cloud fraction near -10C isotherm (discard below thick cloud)'                         )
   call addfld ('CLD_ISOTM_15C' ,           horiz_only, 'A', ' ', 'Total cloud fraction near -15C isotherm (discard below thick cloud)'                         )
   call addfld ('CLD_ISOTM_20C' ,           horiz_only, 'A', ' ', 'Total cloud fraction near -20C isotherm (discard below thick cloud)'                         )
   call addfld ('CLD_ISOTM_25C' ,           horiz_only, 'A', ' ', 'Total cloud fraction near -25C isotherm (discard below thick cloud)'                         )
   call addfld ('CLD_ISOTM_30C' ,           horiz_only, 'A', ' ', 'Total cloud fraction near -30C isotherm (discard below thick cloud)'                         )
   call addfld ('CLD_ISOTM_35C' ,           horiz_only, 'A', ' ', 'Total cloud fraction near -35C isotherm (discard below thick cloud)'                         )
   call addfld ('CLD_ISOTM_40C' ,           horiz_only, 'A', ' ', 'Total cloud fraction near -40C isotherm (discard below thick cloud)'                         )
   
   call addfld ('CT_CLD_ISOTM_0C' ,            horiz_only, 'A', ' ', 'Total cloudtop cloud fraction near 0C isotherm (discard below thick cloud)'                           )
   call addfld ('CT_CLD_ISOTM_5C' ,            horiz_only, 'A', ' ', 'Total cloudtop cloud fraction near -5C isotherm (discard below thick cloud)'                          )
   call addfld ('CT_CLD_ISOTM_10C' ,           horiz_only, 'A', ' ', 'Total cloudtop cloud fraction near -10C isotherm (discard below thick cloud)'                         )
   call addfld ('CT_CLD_ISOTM_15C' ,           horiz_only, 'A', ' ', 'Total cloudtop cloud fraction near -15C isotherm (discard below thick cloud)'                         )
   call addfld ('CT_CLD_ISOTM_20C' ,           horiz_only, 'A', ' ', 'Total cloudtop cloud fraction near -20C isotherm (discard below thick cloud)'                         )
   call addfld ('CT_CLD_ISOTM_25C' ,           horiz_only, 'A', ' ', 'Total cloudtop cloud fraction near -25C isotherm (discard below thick cloud)'                         )
   call addfld ('CT_CLD_ISOTM_30C' ,           horiz_only, 'A', ' ', 'Total cloudtop cloud fraction near -30C isotherm (discard below thick cloud)'                         )
   call addfld ('CT_CLD_ISOTM_35C' ,           horiz_only, 'A', ' ', 'Total cloudtop cloud fraction near -35C isotherm (discard below thick cloud)'                         )
   call addfld ('CT_CLD_ISOTM_40C' ,           horiz_only, 'A', ' ', 'Total cloudtop cloud fraction near -40C isotherm (discard below thick cloud)'                         )

   call addfld ('SLFXCLD_ISOTM_0C' ,            horiz_only, 'A', ' ', 'Mean supercooled liquid fraction near 0C isotherm * CLD_ISOTM (discard below thick cloud)'                           )
   call addfld ('SLFXCLD_ISOTM_5C' ,            horiz_only, 'A', ' ', 'Mean supercooled liquid fraction near -5C isotherm * CLD_ISOTM (discard below thick cloud)'                          )
   call addfld ('SLFXCLD_ISOTM_10C' ,           horiz_only, 'A', ' ', 'Mean supercooled liquid fraction near -10C isotherm * CLD_ISOTM (discard below thick cloud)'                         )
   call addfld ('SLFXCLD_ISOTM_15C' ,           horiz_only, 'A', ' ', 'Mean supercooled liquid fraction near -15C isotherm * CLD_ISOTM (discard below thick cloud)'                         )
   call addfld ('SLFXCLD_ISOTM_20C' ,           horiz_only, 'A', ' ', 'Mean supercooled liquid fraction near -20C isotherm * CLD_ISOTM (discard below thick cloud)'                         )
   call addfld ('SLFXCLD_ISOTM_25C' ,           horiz_only, 'A', ' ', 'Mean supercooled liquid fraction near -25C isotherm * CLD_ISOTM (discard below thick cloud)'                         )
   call addfld ('SLFXCLD_ISOTM_30C' ,           horiz_only, 'A', ' ', 'Mean supercooled liquid fraction near -30C isotherm * CLD_ISOTM (discard below thick cloud)'                         )
   call addfld ('SLFXCLD_ISOTM_35C' ,           horiz_only, 'A', ' ', 'Mean supercooled liquid fraction near -35C isotherm * CLD_ISOTM (discard below thick cloud)'                         )
   call addfld ('SLFXCLD_ISOTM_40C' ,           horiz_only, 'A', ' ', 'Mean supercooled liquid fraction near -40C isotherm * CLD_ISOTM (discard below thick cloud)'                         )
 
   call addfld ('CT_SLFXCLD_ISOTM_0C' ,            horiz_only, 'A', ' ', 'Mean cloudtop supercooled liquid fraction near 0C isotherm * CLD_ISOTM (discard below thick cloud)'                           )
   call addfld ('CT_SLFXCLD_ISOTM_5C' ,            horiz_only, 'A', ' ', 'Mean cloudtop supercooled liquid fraction near -5C isotherm * CLD_ISOTM (discard below thick cloud)'                          )
   call addfld ('CT_SLFXCLD_ISOTM_10C' ,           horiz_only, 'A', ' ', 'Mean cloudtop supercooled liquid fraction near -10C isotherm * CLD_ISOTM (discard below thick cloud)'                         )
   call addfld ('CT_SLFXCLD_ISOTM_15C' ,           horiz_only, 'A', ' ', 'Mean cloudtop supercooled liquid fraction near -15C isotherm * CLD_ISOTM (discard below thick cloud)'                         )
   call addfld ('CT_SLFXCLD_ISOTM_20C' ,           horiz_only, 'A', ' ', 'Mean cloudtop supercooled liquid fraction near -20C isotherm * CLD_ISOTM (discard below thick cloud)'                         )
   call addfld ('CT_SLFXCLD_ISOTM_25C' ,           horiz_only, 'A', ' ', 'Mean cloudtop supercooled liquid fraction near -25C isotherm * CLD_ISOTM (discard below thick cloud)'                         )
   call addfld ('CT_SLFXCLD_ISOTM_30C' ,           horiz_only, 'A', ' ', 'Mean cloudtop supercooled liquid fraction near -30C isotherm * CLD_ISOTM (discard below thick cloud)'                         )
   call addfld ('CT_SLFXCLD_ISOTM_35C' ,           horiz_only, 'A', ' ', 'Mean cloudtop supercooled liquid fraction near -35C isotherm * CLD_ISOTM (discard below thick cloud)'                         )
   call addfld ('CT_SLFXCLD_ISOTM_40C' ,           horiz_only, 'A', ' ', 'Mean cloudtop supercooled liquid fraction near -40C isotherm * CLD_ISOTM (discard below thick cloud)'                         )
...
! manual vars jks 
   ...
   call add_default ('CLD_ISOTM_0C',               1, ' ')
   !--- !zsm, jks
...
!akc6-
   ...
   ! manual vars jks
   call outfld( 'CLD_ISOTM_0C',                       cld_isotm(1,:),             pcols,lchnk )
