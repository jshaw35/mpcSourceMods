...
subroutine hetfrz_classnuc_calc( &
   ...
   fn,                                        &
   r3lx, icnlx,                               &
   frzbcimm,frzduimm,frzduimm_d1,frzduimm_d3, &   ! jks
   frzbccnt, frzducnt,                        &
   frzbcdep, frzdudep,                        &
   ...
   real(r8), intent(out) :: frzduimm_d1        ! het. frz by dust1 immersion nucleation [cm-3 s-1] ! jks
   real(r8), intent(out) :: frzduimm_d3        ! het. frz by dust3 immersion nucleation [cm-3 s-1] ! jks
   ...
   if (t > 263.15_r8) then
      frzduimm = 0._r8
      frzduimm_d1 = 0._r8 ! jks
      frzduimm_d3 = 0._r8 ! jks
      frzbcimm = 0._r8
   end if
